...
async function main() {
  ...
  // // NOTE: approval happens in lvfVault.js
  // await usdc.approve(vaultCa, new BigNumber(2).pow(96).minus(1).toFixed(0), {
  ...
  await vault.deposit(
    new BigNumber('0.01')
      .times(new BigNumber(10).pow(await usdc.decimals()))
      .toFixed(0),
    deployer.address,
    {
      nonce: nonceCounter.increment(),
