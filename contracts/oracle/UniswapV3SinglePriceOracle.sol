...
contract UniswapV3SinglePriceOracle is ChainlinkSinglePriceOracle {
  ...
  function getPriceUSD18(
    ...
    uint256 _quotePriceX96 = _getPoolPriceTokenDenomenator(
      _quoteToken,
      _quoteV3Pool,
  ...
  function _getPoolPriceTokenDenomenator(
    ...
    return
      _normalizedPriceX96(
        ...
        _interval,
        _t0 == _priceToken ? IUniswapV3Pool(_pricePool).token1() : _t0
      );
  }

  function _getSqrtPriceX96FromPool(
