...
import "../libraries/PoolAddressPancakeswap.sol";
import "../libraries/TickMath.sol";

contract V3TwapPancakeswapUtilities is IV3TwapUtilities, Ownable {
        ...
        returns (address)
    {
        ...
        PoolAddressPancakeswap.PoolKey memory _key =
            PoolAddressPancakeswap.PoolKey({token0: _token0, token1: _token1, fee: _poolFee});
        return PoolAddressPancakeswap.computeAddress(_v3Factory, _key);
    }
