...
import "../libraries/PoolAddressKodiak.sol";
import "../libraries/TickMath.sol";

contract V3TwapKodiakUtilities is IV3TwapUtilities, Ownable {
        ...
        returns (address)
    {
        ...
        PoolAddressKodiak.PoolKey memory _key =
            PoolAddressKodiak.PoolKey({token0: _token0, token1: _token1, fee: _poolFee});
        return PoolAddressKodiak.computeAddress(_v3Factory, _key);
    }
